...
public class InterviewMapper {
	...
	public static InterviewResponseDto mapToInterviewResponseDto(Interviews interview, User interviewer,
			User interviewee) {
	...
	public static InterviewsOM mapToInterview(interviewDtoOM dto, List<User> interviewees, User interviewer) {
		InterviewsOM interview = new InterviewsOM();
		interview.setInterviewerId(interviewer.getId());

		List<Integer> intervieweeIds = new ArrayList<>();
		for (User interviewee : interviewees) {
			intervieweeIds.add(interviewee.getId());
		}

		interview.setIntervieweeId(intervieweeIds);
